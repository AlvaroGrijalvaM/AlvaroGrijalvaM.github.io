  ...
  return(
    <main className="page page--contacto">
      <section className="section">
        ...
        <p className="section__subtitle">Estoy disponible para colaborar en proyectos interesantes. No dudes en contactarme.</p>
        <div className="contact-grid">
          <a href="mailto:algm522rx@gmail.com" className="contact-card" aria-label="Enviar correo electrónico">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <rect x="2" y="4" width="20" height="16" rx="2" stroke="currentColor" strokeWidth="2"/>
              <path d="M22 6L12 13L2 6" stroke="currentColor" strokeWidth="2"/>
            </svg>
            <span className="contact-card__label">Email</span>
            <span className="contact-card__value">algm522rx@gmail.com</span>
          </a>

          <a href="https://wa.me/526535384490" target="_blank" rel="noopener noreferrer" className="contact-card" aria-label="Contactar por WhatsApp">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <span className="contact-card__value">+52 653 538 4490</span>
          </a>

          <a href="https://github.com/AlvaroGrijalvaM" target="_blank" rel="noopener noreferrer" className="contact-card" aria-label="Visitar perfil de GitHub">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <span className="contact-card__value">github.com/AlvaroGrijalvaM</span>
          </a>
        </div>
      </section>
    </main>
